...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="resources/css/choco2.css">
        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://i7.fnp.com/images/pr/l/three-layer-chocolaty-wishes_1.jpg" width="400" class="image">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>Dairy Milk Chocolate </h1>
                            <h3>Cadbury Dairy Milk Chocolates - 42 (12.5 grams)</h3>
                            <h3>Cadbury Chocolairs Gold - 45</h3>
                            ...
                            <input type="hidden" name="Item_name" value="Dairy Milk Chocolate">
