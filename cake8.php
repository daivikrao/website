...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="resources/css/cake8.css">
        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://cdn.shopify.com/s/files/1/0319/1449/2041/products/Naked-red-velvet_large.jpg?v=1599109139" class="image">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>NAKED RED VELVET CAKE</h1>
                            <h3>Dig into the red velvet cake that has naked layers of rich red velvet sponge and cream cheese icing.</h3>
                            ...
                            <input type="hidden" name="Item_name" value="NAKED RED VELVET CAKE">
