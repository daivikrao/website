...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="resources/css/gift1.css">
        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://oyehappy.sgp1.digitaloceanspaces.com/wp-content/uploads/2016/02/VIS_1437-resized.jpg" class="image" height="400" width="400">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>Red Jar Velvet</h1>
                            <h3>A jar filled with layers of red velvet cake and cheese cream</h3>
                            <div class="number-button">
                                <label for="number">Quantity</label>
                                <input type="number" class="button-number" id="number" value="1" min="1">
                            </div>
                            <div class="location">
                            ...
                            <input type="hidden" name="Item_name" value="Red Jar Velvet">
