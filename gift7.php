        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQGuP3KCqsKHHsqwbvWbKhZUCK_Yp0o3VH0QA&usqp=CAU" class="image" height="400" width="400">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>Happy donuts</h1>
                            <h3>Variety of delicious Donuts- 6 pcs.</h3>
                            <div class="location">
                            ...
                            <input type="hidden" name="Item_name" value="Happy donuts">
