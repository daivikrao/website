...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="resources/css/cake6.css">
        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://cdn.shopify.com/s/files/1/0319/1449/2041/products/Lotus-biscoff_large.jpg?v=1602609588" class="image">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>LOTUS BISCOFF BEAUTY</h1>
                            <h3>The cheesecake just got better with smooth caramel finish and Lotus biscuits</h3>
                            ...
                            <input type="hidden" name="Item_name" value="LOTUS BISCOFF BEAUTY">
