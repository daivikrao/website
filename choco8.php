...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="resources/css/choco8.css">
        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcSPAKGpuHEPsaf47NDwWkQJSnmoxpULLt2m0pscxuOkvyEAw1uOL0294Sal-giOITe7AVPcXMFUvLDy8e337eGS4y-0NDKfD3EChm_JpbrRoUREMQ&usqp=CAE" width="430" class="image">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>Liquor Chocolates</h1>
                            <div class="location">
                            ...
                            <input type="hidden" name="Item_name" value="Liquor Chocolates">
