...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="resources/css/choco7.css">
        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://d3cif2hu95s88v.cloudfront.net/live-site-2016/product-image/13thJan/wheel-of-happiness-350x350.JPG" width="430" class="image">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>Wheel of Happiness</h1>
                            <ul>
                                <li>10 Assorted Heart-shaped Chocolates</li>
                            ...
                            <input type="hidden" name="Item_name" value="Wheel of Happiness">
