        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://res.cloudinary.com/ufn/image/upload/c_pad,f_auto,q_auto,fl_progressive,dpr_1.5,w_241,h_270/1533654488324_2.jpg" class="image" height="400" width="400">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            ...
                            <h3>Aromatic Ginger bread cookies with blueberry spread - 16 pcs.</h3>
                            <div class="location">
                            ...
                            <input type="hidden" name="Item_name" value="Christmas cookies">
