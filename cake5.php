...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="resources/css/cake5.css">
        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://cdn.shopify.com/s/files/1/0319/1449/2041/products/rainbow_large.jpg?v=1596520009" class="image">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>RAINBOW CAKE</h1>
                            <h3>A stunning celebration cake comprising of seven vibrant and colorful layers with a cream cheese frosting. Look at the brighter side of life and celebrate it as well.</h3>
                            <div class="location">
