        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://cdn.shopify.com/s/files/1/1385/6251/products/24_57_d4be531f-7870-4b36-8ac2-e51fa4e4a7d5_1024x.jpg?v=1571604503" class="image" height="400" width="400">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>Cake-sicle</h1>
                            <h3>Cake balls dipped in variety of chocolates</h3>
                            <div class="location">
                            ...
                            <input type="hidden" name="Item_name" value="Cake-sicle">
