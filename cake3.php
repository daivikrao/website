...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="resources/css/cake3.css">
    ...
    <body>
        ...
        border-radius: 6px;
        outline: none; position:absolute;left:4.5%;top:4.5%;">My Cart (<?php echo $count; ?>)</a><?php
                $count = 0;
                if(isset($_SESSION['cart']))
                {
                    $count = count($_SESSION['cart']);
        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://cdn.shopify.com/s/files/1/0319/1449/2041/products/Tiramisu-gianduja_large.jpg?v=1602606621" class="image">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>TIRAMISU GIANDUJA</h1>
                            <h3>A decadent combination of creamy dark Chocolate ganache and hazelnuts with aromatic coffee</h3>
                            <div class="location">
                            ...
                            <input type="hidden" name="Item_name" value="TIRAMISU GIANDUJA">
                            <input type="hidden" name="Price" value="1950.00">
                        </div>
                    </form>
                </div>
            </div>
