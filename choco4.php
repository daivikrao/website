...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="resources/css/choco4.css">
        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://www.busylittlechefs.com/wp-content/uploads/2018/10/chocolate-covered-oreos-for-fall.jpg" width="430" class="image">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>Classic Chocolate Dipped Oreos</h1>
                            <ul>
                                <li>16 Hand Dipped and Decorated Oreo Cookies placed in 2 decadent layers!</li>
                                <li>All Cookies are placed inside a bright red tin!</li>
                            </ul>
                            <div class="location">
                            ...
                            <input type="hidden" name="Item_name" value="Classic Chocolate Dipped Oreos">
