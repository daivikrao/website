...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="resources/css/cake1.css">
        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://cdn.shopify.com/s/files/1/0319/1449/2041/products/belgium-truffle_large.jpg?v=1596519154" class="image">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>BELGIUM CHOCOLATE TRUFFLE</h1>
                            <h3>Dark chocolate based signature cake, it has soft chocolate sponge layered indulgently with dark chocolaty ganache. It is the best truffle cake to dive into if eggless is how you would like it.</h3>
                            ...
                            <input type="hidden" name="Item_name" value="BELGIUM CHOCOLATE TRUFFLE">
