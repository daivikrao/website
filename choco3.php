...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="resources/css/choco3.css">
        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://i1.fnp.com/images/pr/l/v20201014151043/festive-theme-assorted-chocolate-box-21-pcs_3.jpg" width="430" class="image">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>Festive Theme Chocolate Box</h1>
                            <ul>
                                <li>21 Assorted Chocolates</li>
                                <li>One Chocolate Box</li>
                            </ul>
                            <div class="location">
                            ...
                            <input type="hidden" name="Item_name" value="Festive Theme Chocolate Box">
