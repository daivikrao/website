        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://images-na.ssl-images-amazon.com/images/I/71kvZh-SFCL._SL1500_.jpg" class="image" height="400" width="400">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>Cookie Basket</h1>
                            <h3>Basket of assorted cookies - 5 pcs. each</h3>
                            <div class="location">
                            ...
                            <input type="hidden" name="Item_name" value="Cookie Basket">
