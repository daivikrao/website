        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://www.zabars.com/on/demandware.static/-/Sites-CATALOG_Zabars/default/dwd99530ad/images/categories/gift-baskets-boxes/01-gift-baskets.jpg" class="image" height="400" width="400">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>Loafng Around</h1>
                            <h3>Basket of freshly baked assorted homemade breads</h3>
                            <div class="location">
                            ...
                            <input type="hidden" name="Item_name" value="Loafng Around">
