        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://www.ohnuts.com/noapp/showImage.cfm/extra-large/_MG_00933.jpg" class="image" height="400" width="400">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>Gourmet Giant Marshmellow</h1>
                            <h3>Platter of soft and tasty marshmellow- 16 pcs. </h3>
                            <div class="location">
                            ...
                            <input type="hidden" name="Item_name" value="Gourmet Giant Marshmellow">
