...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="resources/css/cake9.css">
        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://cdn.shopify.com/s/files/1/0319/1449/2041/products/ras-e-rasmalai_large.jpg?v=1599109042" class="image">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>RAS'E RASMALAI CAKE</h1>
                            <h3>A fusion cake with the best of Indian traditional rasmalais and delicate French macarons.</h3>
                            ...
                            <input type="hidden" name="Item_name" value="RAS RASMALAI CAKE">
