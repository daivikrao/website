...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="resources/css/choco6.css">
        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://cdn.shopify.com/s/files/1/1087/0872/products/Jus_Trufs_Truffles_Set_24_11_13dbb921-9314-48f3-a89a-32708db8b1bd_600x.jpg?v=1571602787" width="430" class="image">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>Pralines Belgian Chocolate Box</h1>
                            <ul>
                                <li>Box contains Belgian Chocolates.Net wt:145 gm, 12 pcs</li>
                            </ul>
                            <div class="location">
                            ...
                            <input type="hidden" name="Item_name" value="Pralines Belgian Chocolate Box">
