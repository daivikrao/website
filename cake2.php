...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="resources/css/cake2.css">
        ...
        <header>
            ...
            <div class="row">
                <ul class="main-nav1">
                    ...
                    <li><a href="recipe.php">Gifts</a></li>
        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://cdn.shopify.com/s/files/1/0319/1449/2041/products/GooeyChocolate_large.jpg?v=1598355079" class="image">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>GOOEY CHOCOLATE CAKE</h1>
                            <h3>A baked chocolate cake that spells chocolate from every corner, it is for the true connoisseur of chocolate. Dig into this delicacy and wrap yourself in true chocolate.</h3>
                            <div class="location">
                            ...
                            <input type="hidden" name="Item_name" value="GOOEY CHOCOLATE CAKE">
                            <input type="hidden" name="Price" value="1575.00">
                        </div>
                    </form>
                </div>
            </div>
