...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="resources/css/cake7.css">
        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://cdn.shopify.com/s/files/1/0319/1449/2041/products/new-york-baked_large.jpg?v=1596519859" class="image">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>NEW YORK BAKED CHEESE CAKE</h1>
                            <h3>Among the best cheesecakes, the New York baked cream cheese Cake is truly indulgent, which is why it is so dense and rich. Not to mention, delicious and yum. </h3>
                            ...
                            <input type="hidden" name="Item_name" value="NEW YORK BAKED CHEESE CAKE">
