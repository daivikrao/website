...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="resources/css/choco5.css">
        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://cdn1.1800baskets.com/wcsstore/Baskets/images/catalog/94169x.jpg?width=545&height=597&quality=80&auto=webp&optimize={medium}" width="430" class="image">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>Festive Holiday Caramel Pretzels</h1>
                            <div class="location">
                            ...
                            <input type="hidden" name="Item_name" value="Festive Holiday Caramel Pretzels">
