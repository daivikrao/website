...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="resources/css/choco9.css">
        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://cdn.shopify.com/s/files/1/1087/0872/products/Jus_trufs_-_72_dark_chocolate_-_01_590773c8-1342-42ec-b83c-2da6eb3e0735_600x.jpg?v=1571602787" width="430" class="image">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>Couverture Chocolate Bar</h1>
                            <div class="location">
                            ...
                            <input type="hidden" name="Item_name" value="Couverture Chocolate Bar">
