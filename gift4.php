        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://i.pinimg.com/originals/b7/28/5a/b7285a7a4c2beabdf24a41aa41ab1843.jpg" class="image" height="400" width="400">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>DIY Baking Kit</h1>
                            <h3>The basic beginner baking kit for learners of all age</h3>
                            <div class="location">
                            ...
                            <input type="hidden" name="Item_name" value="DIY Baking Kit">
