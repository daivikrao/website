        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://www.arttowngifts.com/v/vspfiles/photos/GBDSLF-10000S1-2.jpg?v-cache=1492250103" class="image" height="400" width="400">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            ...
                            <h3>Fresh strawberries directly from the farm dipped in chocolate- 9 pcs.</h3>
                            <div class="location">
                            ...
                            <input type="hidden" name="Item_name" value="Strawberry Delight">
