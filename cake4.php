...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="resources/css/cake4.css">
        ...
        <section class="just-one">
            <div class="row">
                <div class="col span-1-of-2">
                    <div>
                        <img src="https://cdn.shopify.com/s/files/1/0319/1449/2041/products/intense_large.jpg?v=1596519546" class="image">
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <form action="manage_cart.php" method="POST">
                        <div class="text-area">
                            <h1>INTENSE 70% CHOCOLATE CAKE</h1>
                            <h3>A delicious dessert Cake with  70% intense chocolate, the cake is free from gluten, free of flour, and is pure chocolate and nothing else. Bite into a dessert that takes taste and health to the next level.</h3>
                            <div class="location">
                            ...
                            <input type="hidden" name="Item_name" value="INTENSE 70% CHOCOLATE CAKE">
